...
class grocery_CRUD_Model  extends CI_Model  {
    ...
    {
        $this->nt_global_logs->s("update","Na tabela ".$this->table_name.". Dados: ".serialize($post_array));
    ...
    {
        // LOG
        $this->nt_global_logs->s("insert","Na tabela ".$this->table_name.". Dados: ".serialize($post_array));
    ...
    {
        // LOGS
        $this->nt_global_logs->s("delete","Na tabela ".$this->table_name);

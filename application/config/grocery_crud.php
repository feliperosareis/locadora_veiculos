...
/*
You can choose 'minimal' or 'full', 'basic1', 'basic2'
 
Barras personalizadas vc pode declarar e depois usar em

ATENCAO: basic1 e basic2 e as persnonalizadas APEMAS para ckeditor.
   
/assets/grocery_crud/texteditor/config.js
/assets/grocery_crud/js/jquery_plugins/jquery.ckeditor.config.js

*/
$config['grocery_crud_text_editor_type'] = 'basic3';

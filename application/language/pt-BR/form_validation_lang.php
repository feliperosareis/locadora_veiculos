...
$lang['less_than'] = 'O campo %s deve ser menor que %s.';
$lang['greater_than'] = 'O campo %s deve ser maior que %s.';
$lang['is_unique'] = 'Já há um registro com este valor no campo %s.';
$lang['is_unique_update'] = 'Já há um registro com este valor no campo %s.';
$lang['valida_nono_digito'] = 'O campor %s contem um número inválido';
?>